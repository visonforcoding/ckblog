...
<div class="col-xs-12">
    <form id="table-bar-form">
        <div class="table-bar form-inline">
            <a href="/admin/joke/add" class="btn btn-small btn-warning">
...
<script>
    $(function () {
        ...
        $("#list").jqGrid({
            url: "/admin/joke/getDataList",
            datatype: "json",
            mtype: "POST",
            colNames:   
['hash','url','标题','图片','创建时间','操作'],
            colModel: [
{name:'hash',editable:true,align:'center'},
...
{name:'actionBtn',align:'center',viewable:false,sortable:false,formatter:actionFormatter}],
    ...
    function actionFormatter(cellvalue, options, rowObject) {
        ...
        response += '<a title="编辑" href="/admin/joke/edit/' + rowObject.id + '" class="grid-btn "><i class="icon icon-pencil"></i> </a>';
        return response;
    }
            ...
            function doSearch() {
                ...
                function doExport() {
                   ...
                   var searchData = $.zui.store.pageGet('searchData')?$.zui.store.pageGet('searchData'):{};
                    ...
                    $("body").append("<iframe src='/admin/joke/exportExcel?" + searchQueryStr + "' style='display: none;' ></iframe>");
                }
                
             function doView(id) {
                //查看明细
                url = '/admin/joke/view/'+id;
                layer.open({
                    type: 2,
                    title: '查看详情',
                    shadeClose: true,
