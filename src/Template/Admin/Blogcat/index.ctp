...
<div class="col-xs-12">
    <form id="table-bar-form">
        <div class="table-bar form-inline">
            <a href="/admin/blogcat/add" class="btn btn-small btn-warning">
...
{name:'actionBtn',align:'center',viewable:false,sortable:false,formatter:actionFormatter}],
    ...
    function actionFormatter(cellvalue, options, rowObject) {
        ...
        response += '<a title="编辑" href="/admin/blogcat/edit/' + rowObject.id + '" class="grid-btn "><i class="icon icon-pencil"></i> </a>';
        return response;
    }
            ...
            function doSearch() {
                ...
                function doExport() {
                   ...
                   var searchData = $.zui.store.pageGet('searchData')?$.zui.store.pageGet('searchData'):{};
                    ...
                    $("body").append("<iframe src='/admin/blogcat/exportExcel?" + searchQueryStr + "' style='display: none;' ></iframe>");
                }
                
             function doView(id) {
                //查看明细
                url = '/admin/blogcat/view/'+id;
                layer.open({
                    type: 2,
                    title: '查看详情',
                    shadeClose: true,
