...
<?php $this->end() ?> 
<div class="work-copy">
    <?= $this->Form->create($blogcat, ['class' => 'form-horizontal']) ?>
        ...
        <div class="form-group">
        <label class="col-md-2 control-label">同级排名</label>
        <div class="col-md-8">
                        <?php
        ...
        <div class="col-md-8">
                        <?php
            echo $this->Form->input('depth', ['label' => false, 'class' => 'form-control']);
            ?>
        </div>
    </div>
        <div class="form-group">
        <label class="col-md-2 control-label">创建时教</label>
        <div class="col-md-8">
                        <?php
                    ...
                    if (typeof res === 'object') {
                        if (res.status) {
                            layer.alert(res.msg, function () {
                                window.location.href = '/admin/blogcat/index';
                            });
                        } else {
